...
$invitationCode = getRequestValue('invitationCode'); // Special code for the registration
...
if ($isCompleted) {
    ...
    // User option Registration Default
    $sqlRequest = "INSERT INTO `object_options` ( object_id, object_name, name, value, option_type )
    VALUES ( UUID_TO_BIN( $userId, true ), 'users', 'registration', 'UsernameAndPassword', 'string')";
